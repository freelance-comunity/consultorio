...
<body>
  <div id="wrapper">
    <header>
      ...
      <span><img src="{{ asset('img/stethoscope-medical-tool.png') }}" alt=""></span>
    </header>
    <article>
      <h1>Recipient</h1>
      <address contenteditable>
        <p>ConsultApp<br>Fraccionamiento la Gloria, Tuxtla Gtz.</p>
      </address>
      <table class="meta">
        <tr>
          <th><span contenteditable>Receta #</span></th>
        ...
        <tr>
        <th><span contenteditable>Paciente</span></th>
          <td><span contenteditable>Jose</span></td>
        </tr>
      </table>
      <table class="inventory">
        <thead>
          <tr>
            <th><span contenteditable>Tratamiento</span></th>
            <!--<th><span contenteditable>Medico</span></th>
            <th><span contenteditable>Tratamiento</span></th>-->
          </tr>
        </thead>
        <tbody>
          <tr>
            <td><p>ahsioahs</p></td>
           <!-- <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim pariatur, fuga aspernatur! Assumenda, maxime rem excepturi maiores eaque saepe optio. Pariatur cupiditate explicabo doloremque libero quidem illum sequi amet culpa.</span></td>
           <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas, laboriosam odit dicta nobis nesciunt architecto expedita, quis totam vitae suscipit voluptatibus voluptates accusamus provident repudiandae optio laborum culpa quae ad.</td>-->
         </tr>
       </tbody>
     </table>
   </article>
